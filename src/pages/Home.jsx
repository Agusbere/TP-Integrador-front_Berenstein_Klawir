            ...
            <div className="container">
                <div className="home-content">
                    <div className="hero-section">
                        <h1>Eventutti</h1>
                        <p className="hero-subtitle">Descubre, organiza y participa en eventos increíbles</p>
                        <p className="hero-description">
                            Encuentra eventos que te interesen, conecta con otras personas y crea experiencias inolvidables.
                        </p>
                    </div>
                    ...
                    <div className="features-simple">
                        <div className="feature">
                            ...
                            <p>Explora una amplia variedad de eventos cerca de ti. Desde conferencias hasta conciertos.</p>
                        </div>
                        <div className="feature">
                            <div className="feature-icon">⭐</div>
                            <h3>Crea Eventos</h3>
                            <p>Organiza tus propios eventos de manera sencilla y comparte con tu comunidad.</p>
                        </div>
                        <div className="feature">
                            <div className="feature-icon">🤝</div>
                            <h3>Conecta</h3>
                            <p>Conoce personas con intereses similares y amplía tu red social.</p>
                        </div>
                    </div>
                    ...
                    {!isAuthenticated ? (
                        <>
                            <div className="cta-section">
                                ...
                                <p>Únete a miles de personas que ya disfrutan de eventos increíbles</p>
                            </div>
